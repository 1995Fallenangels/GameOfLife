/**
 * Write a description of class gabriellasGame13 here.
 *
...
public class gabriellasGame13 {
    ...
    /**
     * Constructor for objects of class gabriellasGame13
     */
    public gabriellasGame13() {
        ...
        newBoard = board;
        System.out.println("Welcome to Gabriella's Game of Life."); //This is the opening to my game
        starterMenu();
    }
    ...
    public void starterMenu() {
        String option = "";
        //this prints out the options for the starter menu
        ...
        while (!option.equals("0")) //This is a while loop for my starter menu. While the user input is not 0(to start game), then the starter menu will keep reappearing after every input.
        {
            option = kb.nextLine();
            if (option.equals("1")) {
                System.out.println("How to play:");
                System.out.println("1. Choose which cells you want to be alive by entering it's x and y coordinates. Then enter 's' when you're done editing the grid");
    ...
    public void askingUserCoordinates() {
        ...
        System.out.println("If you want to stop adding more cells enter 's' or enter any key to continue");
        String input = kb.nextLine();
        input = input.toLowerCase(); //This makes it so if the user inputs a capital 'S' then it will turn it to a lowercase S and will stop the editing.
    ...
    public void addingMoreCells() {
        while (continuingGame) {
            stillEditing = true;
            //I have set stillEditing to true before running the startGame method because if I didn't the game would skip to ask how many generations would like to be run.
    ...
    //This method shows the options that appear when the game has gone through a number of generations. The user can eaither add more cells to the grid or the user can run more generations or quit the game.
    public void endGameOption() {
        ...
        while (!option.equals("3")) //This is a while loop for my starter menu. While the user input is not 0(to start game), then the starter menu will keep reappearing.
        {
            ...
            } else if (option.equals("3")) {} //if the user enters 3 then it will proceed to clearScreen()
            else if (!option.equals("3")) {
                System.out.println("Please enter 1, 2, or 3.");
            } //
        }
        clearScreen(); //clears the screen
        System.out.println("Thank you for playing Gabriella's Game of Life :3"); //this prints out a message when the game ends
        kb.close(); //this closes the scanner so the game ends.
    }
