/**
 * Write a description of class gabriellasGame17 here.
 *
...
public class gabriellasGame17 {
    ...
    /**
     * Constructor for objects of class gabriellasGame17
     */
    public gabriellasGame17() {
    ...
    public void askingUserCoordinates() {
        ...
        int usersXCoordinate = askForInt("enter the number of only the x coordinate of the cell you want to change (e.g 10)", 0, 21);
        //this asks for the y coordinate of the cell they want to change
        int usersYCoordinate = askForInt("enter the number of only the y coordinate of the cell you want to change (eg.5)", 0, 21);
    ...
    public void stopAddingCells() {
        //this asks the user if they want to continue cells or stop adding cells
        System.out.println("To continue adding cells enter 'c', to stop adding cells enter 's'");
