/**
 * Write a description of class gabriellasGame9 here.
 *
 * @author Gabriella Bitju
 * @version 06/07/2023
 * This game is Gabriella's Game of Life (based on the game Conway's Game of Life)
 * This game is zero player game. It is played on a 2D grid, where every square is a cell.
...
public class gabriellasGame9
{
    int gridSize=21;//I have set the grid size to 20 (I put in 21 because the grid starts at 0).
    int board[][]=new int[gridSize][gridSize];// defining my 2D array. It will be a 21 by 21 grid
    int newBoard[][] = new int[gridSize][gridSize];//I made another board
    int userPickx=0;
    int userPicky=0;
    ...
    //below are methods, I have put components of my game into methods to make it easier for me to call them, to make my code more organized, and to prevent errors.
        ...
        public void askingUserCoordinates()
        {
            ...
            System.out.println("If you want to stop enter 's' or enter any key to continue");
    ...
    //This method applies the rules of Conways Game of life, it scans the 8 cells around each cell and turns it on and off based on the previous state of the grid.
