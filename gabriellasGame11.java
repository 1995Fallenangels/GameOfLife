...
public class gabriellasGame11
{
    ...
    /**
     * Constructor for objects of class gabriellasgame11
     */
    public gabriellasGame11()
        {
    ...
    public void starterMenu()
        {
            int option=100000;
            Scanner kb= new Scanner(System.in);//this is my varible for my keyboard scanner
            while (option!=0)// 
            {   
                ...
                else if (option==0){}//if the user inputs 0, nothing will happen and proceed to startGame();
                else
                {
    ...
    // this method will start the game
        public void startGame()
        {
            ...
            for(int generations=GameEngine.askForInt("How many generations do you want to run? (1-1000)",0, 1000); generations > 0; generations--){
                applyingGameRules();
    ...
    //This method asks the user for the coordinates of the cell they want to change. 
        ...
        {
            Scanner kb= new Scanner(System.in);
            int usersXCoordinate=GameEngine.askForInt("enter the x co-ordinate of the cell you want to change",0, 21);
            //this asks for the x coordinate of the cell they want to change 
            int usersYCoordinate=GameEngine.askForInt("enter the y co-ordinate of the cell you want to change",0, 21);
            ...
            for (int y=0;y<gridSize;y++)
                {
                    ...
                    System.out.print(y);//This prints out the y co-ordinates
